...
export function formWithFieldsFilled() {
  return `
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body>
        <form id="form">
          ...
          <div class="form-group">
            ...
            <input type="text" name="email" placeholder="E-mail" data-required value="john.doe@gmail.com" />
          </div>
          ...
          <div class="form-group">
            ...
            <input type="checkbox" name="terms" value="true" data-required checked /> yes
          </div>
          ...
          <div class="form-group">
            ...
            <label>
              <input type="radio" name="gender" value="female" data-required checked /> Female
            </label>
          </div>
